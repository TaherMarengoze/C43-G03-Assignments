...
public partial class NorthwndContext : DbContext
{
    ...
    public virtual DbSet<VwAboveAverageProduct> VwAboveAverageProducts { get; set; }

    public virtual DbSet<VwGermanCustomer> VwGermanCustomers { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder
        .UseLazyLoadingProxies()
        .UseSqlServer("Server=.;Database=NORTHWND;Integrated Security=True;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PriceUpdateLog>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("PriceUpdateLog");
        ...
        modelBuilder.Entity<VwAboveAverageProduct>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_AboveAverageProducts");
        ...
        modelBuilder.Entity<VwGermanCustomer>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_German_Customers");
